...
export class ContinuousRecognizer implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public updateView(context: ComponentFramework.Context<IInputs>): void
	{
		...
		{
			setTimeout( () => {this.sdkStartContinuousRecocgnitionBtn();},wasRecording ? 500: 100);
		}
	...
	public getOutputs(): IOutputs
	{
		...
		let result: IOutputs = {
			...
			RecognizedPhraseId: this.lastMessage.resultId + '.' + this.lastMessage.offset
					};
			return result;
	}
